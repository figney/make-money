    ...
    protected function form()
    {
        ...
        return Form::make(new Setting(), function (Form $form) use ($language) {
            ...
            $form->tab("基础", function (Form $form) {
                ...
                $form->text('rmb_money_rate', '人民币- ' . Setting("default_currency") . ' 汇率')->width(2)->required()->help('usdt_money_rate：1元=多少' . Setting("default_currency"));
